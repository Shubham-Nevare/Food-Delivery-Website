...
function Card2({name, id, image, price, qty}) {
  ...
  return (
    <div className='w-full h-[90px]  p-2 shadow-lg flex justify-between '>
        <div className='w-[60%] h-full  flex gap-5'>
            ...
            <div className='w-[40%] h-full flex flex-col gap-3'>
                ...
                <div className='w-[100px] h-[30px] bg-slate-400 flex rounded-lg overflow-hidden shadow-lg font-semibold border-2 border-green-400 text-xl'>
        ...
        <div className='flex flex-col justify-start items-end gap-6'>
            ...
            <RiDeleteBin6Line className='w-[25px] h-[25pc] text-red-400 cursor-pointer' onClick={()=>{dispatch(RemoveItem(id)); 
